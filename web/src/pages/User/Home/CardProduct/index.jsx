        ...
        <article className="card-product">
            <header className="card-header">
                <div className="img-content">
                    <Link to="/product/1">
                        <img src="https://images.unsplash.com/photo-1518791841217-8f162f1e1131?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60" alt="product" />
                    </Link>
                </div>
                <div className="card-body">
                    ...
                    <p>
                        Tu descripción del producto Lorem ipsum dolor sit.
                    </p>
                </div>
            </header>
